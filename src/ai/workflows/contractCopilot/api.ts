...
export type ContractCopilotApiSuccessResponse = {
  ...
  debug?: {
    ...
    clarificationInsteadOfFallback?: boolean;
    fallbackEntryReason?: string;
    aiPathSkippedReason?: string;
    ...
    contractBrainWhatControls?: string;
    contractBrainVisibleSupportSections?: string[];
    contractBrainSourceLimitationNotes?: string[];
    contractBrainTrustLevel?: "resolved" | "caution" | "warning";
    contractBrainUnsupportedClaims?: string[];
    ...
    orchestratorOwnsScenarioPipeline?: boolean;
    legacyCompatPipelineUsed?: boolean;
    orchestratorStages?: Record<string, unknown>;
    scenarioType?: string;
    selectedScenarioFamilyFinal?: string;
    turnId?: string;
    questionHash?: string;
    answerScenarioFamily?: string;
    supportScenarioFamily?: string;
    debugScenarioFamily?: string;
    payCreditSubScenario?: string;
    answerSubScenario?: string;
    supportSubScenario?: string;
    debugSubScenario?: string;
    clarificationTriggered?: boolean;
    supportFinalFilterRemoved?: number;
    supportFinalFilterRemovedReasons?: string[];
    pipelineLeakDetected?: boolean;
    finalResponseCoherenceFailed?: boolean;
    finalResponseMismatchReason?: string;
    productionScenarioFamily?: string;
    shadowScenarioFamily?: string;
    shadowSubScenario?: string;
    shadowAnswerSummary?: string;
    shadowSupportSections?: string[];
    shadowAiPathUsed?: boolean;
    shadowFallbackUsed?: boolean;
    shadowCoherenceFailed?: boolean;
    shadowDiffFromProduction?: string[];
    shadowMismatchDetected?: boolean;
    productionAnswerHash?: string;
    shadowAnswerHash?: string;
    productionSupportSections?: string[];
  };
};
